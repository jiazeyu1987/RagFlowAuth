...
def _build_repo(root: Path) -> None:
    docs = {
        "docs/compliance/maintenance_plan.md": """# 维护计划
...
""",
        "docs/compliance/maintenance_review_status.md": """# 维护复核状态
版本: v1.0
更新时间: 2026-04-03
最后仓库复核日期: 2026-04-03
...
""",
        "docs/compliance/intended_use.md": """# 预期用途
版本: v1.0
更新时间: 2026-04-03
...
| R7 | URS-007 | SRS-007 | `backend/services/config_change_log_store.py` | `backend.tests.test_r7_compliance_gate_unit` | `docs/compliance/validation_plan.md` | 已验证 |
| R8 | URS-008 | SRS-008 | `backend/app/modules/audit/router.py` | `backend.tests.test_audit_events_api_unit` | `docs/compliance/validation_report.md` | 已验证 |
| R9 | URS-009 | SRS-009 | `backend/database/tenant_paths.py` | `backend.tests.test_tenant_db_isolation_unit` | `docs/compliance/tenant_db_migration_plan.md` | 已验证 |
| R10 | URS-010 | SRS-010 | `backend/services/data_security/store.py` | `backend.tests.test_backup_restore_audit_unit` | `docs/compliance/validation_report.md` | 已验证 |
