...
def _make_minimal_repo(root: Path) -> None:
    _write(
        root / "docs/compliance/gmp_regulatory_baseline.md",
        """# GMP 基线
版本: v1.0
更新时间: 2026-04-02
...
""",
    ...
    _write(
        root / "docs/compliance/r7_periodic_review_status.md",
        """# R7 周期复核状态
版本: v1.0
更新时间: 2026-04-02
最后仓库复核日期: 2026-04-02
...
""",
    ...
    _write(root / "docs/compliance/intended_use.md", "# Intended Use\n版本: v1.0\n更新时间: 2026-04-02\n")
    _write(root / "docs/compliance/urs.md", "# URS\n版本: v1.0\n更新时间: 2026-04-02\n| URS-007 | R7 | text |\n")
    _write(root / "docs/compliance/srs.md", "# SRS\n版本: v1.0\n更新时间: 2026-04-02\n| SRS-007 | URS-007 | text |\n")
    _write(root / "docs/compliance/risk_assessment.md", "# Risk\n版本: v1.0\n更新时间: 2026-04-02\n| RA-010 | text |\n")
    _write(
    ...
    _write(root / "docs/compliance/validation_plan.md", "# Plan\n版本: v1.0\n更新时间: 2026-04-02\npython scripts/validate_r7_repo_compliance.py\n")
    _write(
        root / "docs/compliance/validation_report.md",
        "# Report\n版本: v1.0\n更新时间: 2026-04-02\n仓库内门禁校验通过；不替代线下签字\n",
    )
...
class TestR7ComplianceGateUnit(unittest.TestCase):
    ...
    def test_validator_flags_overdue_periodic_review(self):
        ...
        try:
            root = Path(tmp)
            _make_minimal_repo(root)
            (root / "docs/compliance/r7_periodic_review_status.md").write_text(
                """# R7 周期复核状态
版本: v1.0
更新时间: 2026-04-02
最后仓库复核日期: 2026-04-02
