...
def get_settings(_: AdminOnly) -> dict[str, Any]:
...
def update_settings(_: AdminOnly, body: dict[str, Any]) -> dict[str, Any]:
    store = DataSecurityStore()
...
def run_backup(_: AdminOnly) -> dict[str, Any]:
    try:
...
def list_jobs(_: AdminOnly, limit: int = 30) -> dict[str, Any]:
    store = DataSecurityStore()
...
def get_job(_: AdminOnly, job_id: int) -> dict[str, Any]:
    store = DataSecurityStore()
    try:
...
def run_full_backup(_: AdminOnly) -> dict[str, Any]:
...
def cancel_backup_job(_: AdminOnly, job_id: int, body: dict[str, Any] | None = None) -> dict[str, Any]:
    """
