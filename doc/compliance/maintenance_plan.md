...
- 当前受控文档: `doc/compliance/intended_use.md`、`doc/compliance/traceability_matrix.md`、`doc/compliance/validation_plan.md`、`doc/compliance/validation_report.md`
...
1. 变更前先完成维护影响判定。
2. 维护影响判定必须引用 `doc/compliance/traceability_matrix.md` 作为输入。
