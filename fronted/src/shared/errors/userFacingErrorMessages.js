const EXACT_ERROR_MESSAGES = {
  ...
  document_control_workflow_not_configured: 'The document control approval workflow is not configured.',
  document_control_pdf_required: 'Document control uploads must be PDF files.',
  document_control_approval_step_remind_failed: 'Approval overdue reminder could not be sent.',
  document_control_reviewer_required: 'A reviewer must complete the review step before approval.',
  document_control_training_pending_assignment: 'Training is required before release. Please generate training assignments first.',
  document_control_training_in_progress: 'Training is still in progress. Complete all required acknowledgments before release.',
  document_control_training_questions_open: 'Training questions are still open. Resolve them before release.',
  document_control_training_gate_blocked: 'Training requirements are blocking release.',
  document_control_distribution_departments_missing: 'Please set the distribution departments before publishing.',
  product_name_required: 'Please provide the product name.',
  registration_ref_required: 'Please provide the registration reference.',
  document_control_matrix_file_subtype_required: 'Please select a file subtype.',
  document_control_matrix_file_subtype_not_found: 'The selected file subtype is not configured in the approval matrix.',
  document_control_matrix_compiler_mismatch: 'The current user does not match the compiler role required by the approval matrix.',
  document_control_matrix_missing: 'The approval matrix is unavailable. Please contact an administrator.',
  document_control_matrix_usage_scope_required: 'This file subtype requires usage scope data before the approval matrix can be resolved.',
  controlled_revision_id_required: 'Revision information is missing. Please refresh and try again.',
  controlled_document_id_required: 'Document information is missing. Please refresh and try again.',
  approver_user_id_required: 'Please provide the approver user id.',
  assignee_user_ids_required: 'Please provide at least one assignee user id.',
  training_assignment_assignees_required: 'Please provide at least one assignee.',
  min_read_minutes_invalid: 'Please provide a valid minimum read duration (minutes).',
...
const PREFIX_ERROR_MESSAGES = [
  ...
  ['document_control_department_recipients_missing:', 'At least one selected department has no active recipients.'],
  ['document_control_matrix_position_missing:', 'A required approval position is missing from the quality system configuration.'],
  ['document_control_matrix_position_unassigned:', 'A required approval position has no assigned active users.'],
  ...
  ['quality_system_config_', 'Quality system configuration failed. Please try again later.'],
