...
export const QUALITY_SYSTEM_MODULES = Object.freeze([
  ...
  Object.freeze({
    ...
    title: '\u8bbe\u5907\u4e0e\u8ba1\u91cf',
    owner: 'WS05',
    resource: 'equipment_lifecycle',
    summary: '\u8bbe\u5907\u5168\u751f\u547d\u5468\u671f\u3001\u8ba1\u91cf\u4e0e\u7ef4\u62a4\u4fdd\u517b\u5728\u6b64\u9884\u7559\u3002',
...
export const findQualitySystemModuleByPath = (pathname) => (
  QUALITY_SYSTEM_MODULES.find((module) => module.path === pathname) || null
);
