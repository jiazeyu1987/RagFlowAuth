      ...
      >
        <div>
          <div style={{ fontSize: '1.05rem', fontWeight: 700, color: '#111827' }}>
            {prompt.title || 'Electronic Signature'}
          </div>
          {prompt.description ? (
        ...
        <label style={{ display: 'grid', gap: '6px' }}>
          <span style={{ color: '#111827', fontWeight: 600 }}>Current password</span>
          <input
            type="password"
            value={password}
        ...
        <label style={{ display: 'grid', gap: '6px' }}>
          <span style={{ color: '#111827', fontWeight: 600 }}>Signature meaning</span>
          <input
            type="text"
            value={meaning}
        ...
        <label style={{ display: 'grid', gap: '6px' }}>
          <span style={{ color: '#111827', fontWeight: 600 }}>Reason</span>
          <textarea
            value={reason}
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
          ...
          >
            {submitting ? 'Signing...' : (prompt.confirmLabel || 'Confirm Signature')}
          </button>
        </div>
      </form>
    </div>
